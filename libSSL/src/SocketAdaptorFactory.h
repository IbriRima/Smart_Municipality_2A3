...
*/
#ifndef SOCKETADAPATORFACTORY_H
#define SOCKETADAPATORFACTORY_H
...
class SocketAdaptorFactory
{
public:
    SocketAdaptorFactory();

    ~SocketAdaptorFactory();

    iSocketAdaptor *Create();
};
...
#endif  //  #ifndef SOCKETADAPATORFACTORY_H
